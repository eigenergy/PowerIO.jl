...
@handle ValueHandle :pio_value_release "Owner rooted view of a module value."
@handle BalancedNetworkHandle :pio_balanced_network_release "Owner rooted balanced network."
@handle MulticonductorNetworkHandle :pio_multiconductor_network_release "Owner rooted multiconductor network."
@handle DetailedConnectivityHandle :pio_detailed_connectivity_release "Owner rooted detailed connectivity tables."
...
@handle TimeSeriesHandle :pio_time_series_release "Owner rooted time series."
@handle ScenarioSetHandle :pio_scenario_set_release "Owner rooted scenario set."
@handle OperatingPointHandle :pio_operating_point_release "Owner rooted operating point."
@handle CalculationInstanceHandle :pio_calculation_instance_release "Owner rooted calculation instance."
@handle CalculationSolutionHandle :pio_calculation_solution_release "Owner rooted calculation solution."
