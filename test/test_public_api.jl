...
const RETIRED_NAMES = [
    ...
    :buses, :branches, :generators, :loads, :shunts, :storage, :hvdc, :lines, :line_codes,
    :switches, :transformers, :ibrs, :control_profiles, :capacitors, :voltage_sources,
    :untyped_objects, :n_buses, :n_branches, :n_generators, :n_switches, :base_mva, :base_frequency,
